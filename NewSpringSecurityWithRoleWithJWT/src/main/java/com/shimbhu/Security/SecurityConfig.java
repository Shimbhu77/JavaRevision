...
import com.shimbhu.Jwt.JwtGeneratorFilter;
import com.shimbhu.Jwt.JwtValidationFilter;
...
public class SecurityConfig {
	...
	// CORS configuration
		...
		.authorizeHttpRequests(
				...
				.requestMatchers("/v3/api-docs/**", "/swagger-ui*/**", "/swagger-ui.html","/swagger-ui/**","/swagger-ui/index.html/**", "/swagger-ui/index.html").permitAll()
